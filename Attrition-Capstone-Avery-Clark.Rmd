...
This will also give us separate datasets for each job role, which we'll test for differences later.
...
```{r Analysis 02 e, include=TRUE, warning=FALSE}
...
If you're confused about how to interpret this, look at the explanation of the first RPART plot above.
...
```{r Analysis 02 f, include=TRUE, warning=FALSE}
...
have even more detail and accuracy.
...
Now let's run the same analysis but looking at job roles separately, instead of all job roles together.


Let's start with the job role of Healthcare Representative:

```{r Analysis 02 g, include=TRUE, warning=FALSE}


cat("Now let's look at the Job Role of 
...
cat("That concludes the RPART analysis 
 of the Healthcare Representative job role.")
...
cat("That concludes the RPART analysis 
 of the Human Resources job role.")
...
cat("That concludes the RPART analysis 
 of the Laboratory Technician job role.")
...
cat("That concludes the RPART analysis 
 of the Manufacturing Director job role.")
...
cat("That concludes the RPART analysis 
 of the Research Director job role.")
...
cat("That concludes the RPART analysis 
 of the Research Scientist job role.")
...
cat("That concludes the RPART analysis 
 of the Sales Executive job role.")
...
cat("That concludes the RPART analysis 
 of the Sales Representative job role.")
...
```{r Analysis 03, include=TRUE, warning=FALSE}
